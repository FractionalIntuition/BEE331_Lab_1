...
\begin{document}
	...
	\begin{figure}[hp!]
		...
		\subfloat[\centering LTSpice + Rudimentary Schematic Seris RD ($499\Omega$) Circuit]{\includegraphics[width=19cm]{499 resistor circuit sim}}
	\end{figure}
		\begin{figure}[hp!]
		\ContinuedFloat
		\centering
	...
	Revealed in Figure RD-Circuit 1A \& 1B, the generated oscilloscope readings of the two periodic function match the characteristics of the transfer function found in the transfer function. So the measurements do infact closely align.
	\newpage
